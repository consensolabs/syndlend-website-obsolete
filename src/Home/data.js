...
export const page4 = [
  {
    ...
    avatar:
      "https://pbs.twimg.com/profile_images/1079171000812666881/mFxwF8Jd_400x400.jpg",
    comment:
  ...
  },
  {
    ...
    avatar:
      "https://pbs.twimg.com/profile_images/789922075238596610/9YEriL3__400x400.jpg",
    comment:
      "With Corda as an asset ledger, bank or other firm can issue assets (cash, equities, even commercial paper or syndicated loans) on to the ledger and have them be directly owned and seamlessly transferred to other members of an appropriate business network in near-real-time and with settlement finality."
  },
  {
    name: "Genpact",
    profile: "Professional services",
    avatar:
      "https://banner2.kisspng.com/20181127/jco/kisspng-logo-genpact-brand-portable-network-graphics-produ-genpact-logo-12-vector-logos-5bfceaf5414308.3508120715433018772673.jpg",
    comment:
      "With a decentralized market, a distributed ledger system could serve as an asset register" +
    ...
    children: [
      {
        ...
        children: {
          ...
          post: {
            ...
            children: "Draft white paper and phase 1 implementation"
          },
          ...
          content: {
            ...
            children:
              "Published first version of the white paper. Deployed phase 1 " +
      ...
      },
      {
        ...
        children: {
          ...
          post: {
            className: "block-post",
            children: "Phase 2 implementation with legally compliant system"
          },
          ...
          content: {
            className: "block-content",
            children:
              "Publish elaborated technical white paper with legal compliance and complete " +
      ...
      },
      {
        ...
        children: {
          ...
          post: {
            className: "block-post",
            children: "Reaching out to the financial institutions"
          },
          ...
          content: {
            className: "block-content",
            children:
              "Create a network of syndicated loan market by enrolling " +
      ...
      },
      {
        ...
        children: {
          ...
          content: {
            className: "block-content",
            children:
              "Build a strong team to work with financial institutions " +
